...
INSERT INTO KIMMYEONGHOE.USERS(USER_ID, USER_PW, USER_NAME, BIRTHDAY, CONTACT, EMAIL, POSTCODE, ADDRESS, ADDRESS_DETAIL, JOIN_DATE, WITHDRAWAL_DATE)
      values ('admin','admin', '������', '2021-01-01','0234567890','admin@efgh.com','111111','��⵵ ���� �ϻ굿�� �߾ӷ�','���ּ� �Դϴ�',sysdate,null);
INSERT INTO KIMMYEONGHOE.USERS(USER_ID, USER_PW, USER_NAME, BIRTHDAY, CONTACT, EMAIL, POSTCODE, ADDRESS, ADDRESS_DETAIL, JOIN_DATE, WITHDRAWAL_DATE)
      values ('user','user', 'user', '2021-01-01','01011111111','user@naver.com','111111','��⵵ ���� �ϻ굿�� �߾ӷ�','123-456',sysdate,null);
